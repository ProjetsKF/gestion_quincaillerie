...
if(isset($_POST['btnRechercheClt'])){

    $motCle = trim($_POST['txtRechClt']);

}

$sql = "SELECT * FROM Client
        WHERE CONCAT(nom,' ', postnom,' ',prenom) LIKE :motcle
        LIMIT 7";
...
$clt = $req->fetchAll(PDO::FETCH_ASSOC);
            ...
            <form method="post" action="rechercheClient.php">
                <div class="mb-4">
                    <div class="input-group">
                        <input type="text" class="form-control" name="txtRechClt" 
                               placeholder="Rechercher le client...">
                        <div class="input-group-append">
                            <button type="submit" class="btn btn-primary" name="btnRechercheClt">
